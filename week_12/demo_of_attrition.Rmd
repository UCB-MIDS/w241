...
In general, it is unlikely to be the case that when there is missingness it has occured completely at random. Or at least, because you can't see the data for the people who don't give you their data, you'll never be able to credibly, dispositively assert that missingness occurred at random. :sweat_smile:. 
