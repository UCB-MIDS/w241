...
What you're reading right now is an RStudio notebook -- just a slight turn on the notebook format that you're familiar with in a jupyter notebook. In these notebooks, the default is that you're writing into the "paper", or "markdown" space. But, if you want to incldue a code chunk, you can. 
