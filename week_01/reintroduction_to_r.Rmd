...
With this course, virtually all of our data *could*, in principle, be wrangled in a calculator. There's nothing _necessairily_ fancy required, because we're structuring the comparisons we want to observe *by design* rather than by brute force computation. 
