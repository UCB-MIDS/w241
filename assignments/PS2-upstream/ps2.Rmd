...
But we can also write what the average of this vector is using an inline call. The mean of this vector is `r mean(x)`. When we write "backtick r" we're opening an inline call, in the R language which close with another "backtick". Use this when you're reporting your results whenever possible! 
